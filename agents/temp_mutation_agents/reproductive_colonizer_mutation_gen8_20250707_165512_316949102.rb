...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 2
             ...
             elsif crowded && !adjacent_info[:empty].empty? && my_energy >= 5 # MUTATION: was: elsif crowded && !adjacent_info[:empty].empty? && my_energy >= 6
             ...
             elsif adjacent_info[:agents].size == 1 && adjacent_info[:agents].first[:energy] <= 2 && my_energy >= 4 # MUTATION: was: elsif adjacent_info[:agents].size == 1 && adjacent_info[:agents].first[:energy] <= 3 && my_energy >= 6
