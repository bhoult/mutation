...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 1
             ...
             elsif !living_agents.empty? && !empty_directions.empty? && my_energy >= 6 # MUTATION: was: elsif !living_agents.empty? && !empty_directions.empty? && my_energy >= 5
               ...
               { action: 'replicate' }
             elsif !empty_directions.empty? && rand < 0.6
