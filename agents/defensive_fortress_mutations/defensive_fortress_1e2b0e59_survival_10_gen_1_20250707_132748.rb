...
# =============================================================================
# Original Agent: defensive_fortress
# Content Hash: 1e2b0e59
# Created: 2025-07-07 13:27:48
# Survival Time: 10 ticks
# Generation: 1
# World Size: 3x3
...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 3 # MUTATION: was: action = if my_energy <= 2
             ...
             elsif threats.size == 1 && my_energy >= 5 # MUTATION: was: elsif threats.size == 1 && my_energy >= 8
             ...
             elsif my_energy >= 18 && safe_directions.size >= 4 # MUTATION: was: elsif my_energy >= 18 && safe_directions.size >= 3
