...
# Content Hash: 7b02ba6a
# Created: 2025-07-07 16:47:37
# Survival Time: 235 ticks
# Generation: 13
# World Size: 190x44
...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 2
               ...
               { action: 'rest' }
             elsif energy_percent < 51 && !dead_agent_positions.empty? # MUTATION: was: elsif energy_percent < 50 && !dead_agent_positions.empty?
               ...
               { action: 'move', target: empty_directions.sample }
             elsif my_energy >= 15 && rand < 0.4 # MUTATION: was: elsif my_energy >= 15 && rand < 0.3
