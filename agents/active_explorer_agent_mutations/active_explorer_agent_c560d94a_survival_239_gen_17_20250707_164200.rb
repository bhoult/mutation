...
# =============================================================================
# Original Agent: active_explorer_agent
# Content Hash: c560d94a
# Created: 2025-07-07 16:42:00
# Survival Time: 239 ticks
# Generation: 17
# World Size: 190x44
...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 2
               ...
               { action: 'rest' }
             elsif energy_percent < 49 && !dead_agent_positions.empty? # MUTATION: was: elsif energy_percent < 50 && !dead_agent_positions.empty?
             ...
             elsif !empty_directions.empty? && rand < 0.9 # MUTATION: was: elsif !empty_directions.empty? && rand < 0.7
               # No food visible - explore by moving randomly 70% of the time
               { action: 'move', target: empty_directions.sample }
             elsif my_energy >= 15 && rand < 0.2 # MUTATION: was: elsif my_energy >= 15 && rand < 0.3
