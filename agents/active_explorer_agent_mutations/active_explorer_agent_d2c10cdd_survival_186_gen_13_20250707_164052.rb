...
# Content Hash: d2c10cdd
# Created: 2025-07-07 16:40:52
# Survival Time: 186 ticks
# Generation: 13
# World Size: 190x44
...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 2
             ...
             elsif !empty_directions.empty? && rand < 0.6 # MUTATION: was: elsif !empty_directions.empty? && rand < 0.7
               # No food visible - explore by moving randomly 70% of the time
               { action: 'move', target: empty_directions.sample }
             elsif my_energy >= 15 && rand < 0.1 # MUTATION: was: elsif my_energy >= 15 && rand < 0.3
