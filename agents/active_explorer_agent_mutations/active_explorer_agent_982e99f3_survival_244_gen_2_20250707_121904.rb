...
# Content Hash: 982e99f3
# Created: 2025-07-07 12:19:04
# Survival Time: 244 ticks
# Generation: 2
# World Size: 190x51
...
begin
  while (input = $stdin.gets)
    ...
    action = if my_energy <= 2
             ...
             elsif !empty_directions.empty? && rand < 0.8 # MUTATION: was: elsif !empty_directions.empty? && rand < 0.7
