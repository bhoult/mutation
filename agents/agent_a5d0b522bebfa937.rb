...
def choose_action(world_state, memory)
  ...
  if memory['personality'].nil?
    memory['personality'] = {
      ...
      'death_threshold' => rand(2..2)       # When to give up
    }
  end
  ...
  elsif target_info['energy'] >= 2 && my_energy >= 1 && target_info['energy'] > my_energy && rand < personality['aggression']
